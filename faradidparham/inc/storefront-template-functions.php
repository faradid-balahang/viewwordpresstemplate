...
|
-----------------------------------------------------------------------------*/
if ( ! function_exists( 'storefront_main_navigation' ) ) {
function storefront_main_navigation() {
	?>
	<?php
		               $args = array(
						'theme_location' => 'primary',
...
if ( ! function_exists( 'storefront_social_navigation' ) ) {
	/**
	 ...
	 * @return void
	 */
	function storefront_social_navigation() {
...
if ( ! function_exists( 'storefront_menu_container' ) ) {
	function storefront_menu_container() {
		?>
...
if ( ! function_exists( 'storefront_menu_container_close' ) ) {
	function storefront_menu_container_close() {
		?>
            </div>
            </section>
...
|
-----------------------------------------------------------------------------*/
if ( ! function_exists( 'custome_footer_widgets' ) ) {
	/**
	 * Display the footer widget regions.
	 *
	 * @since  1.0.0
	 * @return void
	 */
	function custome_footer_widgets() {
		$rows    = intval( apply_filters( 'storefront_footer_widget_rows', 1 ) );
		$regions = intval( apply_filters( 'storefront_footer_widget_columns', 4 ) );
			...
			if ( isset( $columns ) ) :
				...
				for ( $column = 1; $column <= $columns; $column++ ) :
					...
					if ( is_active_sidebar( 'footer-' . esc_attr( $footer_n ) ) ) :
						...
						?>
					<div class="footer-widget-<?php echo esc_attr( $column ); ?>  col-12 col-md-<?= intval(12/$columns);?>">
						<?php dynamic_sidebar( 'footer-' . esc_attr( $footer_n ) ); ?>
					</div>
						<?php
					endif;
