...
// custome_footer_widgets

add_action( 'custome_footer_widgets', 'custome_footer_widgets', 10 );
add_action( 'custome_footer_widgets', 'storefront_credit', 20 );
/**
 * Homepage
 *
